////
////  iPadSelectionOptionsViewController.m
////  IOSComponentsSample
////
...
public class SelectionOptions extends ExampleActivityBase{
	@Override
	protected void onCreate(Bundle savedInstanceState) {		 
		super.onCreate(savedInstanceState);
		setContentView(R.layout.example_selection_options);
		this.buildGrid(this.flexDataGrid, R.raw.flxsselectionoptions);
